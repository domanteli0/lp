...
#let core2 = read_data(file: "../lab2/results/2_2.tsv", column: 2)
#let all2 = read_data(file: "../lab2/results/2_2.tsv", column: 3)
#let matrix2 = read_data(file: "../lab2/results/2_2.tsv", column: 1)

#let core4 = read_data(file: "../lab2/results/2_4.tsv", column: 2)
#let all4 = read_data(file: "../lab2/results/2_4.tsv", column: 3)
#let matrix4 = read_data(file: "../lab2/results/2_4.tsv", column: 1)

#let core8 = read_data(file: "../lab2/results/2_8.tsv", column: 2)
#let all8 = read_data(file: "../lab2/results/2_8.tsv", column: 3)
#let matrix8 = read_data(file: "../lab2/results/2_8.tsv", column: 1)
...
#let core3 = read_data(file: "../lab2/results/2_3.tsv", column: 2)
#let all3 = read_data(file: "../lab2/results/2_3.tsv", column: 3)
#let matrix3 = read_data(file: "../lab2/results/2_3.tsv", column: 1)

#let core5 = read_data(file: "../lab2/results/2_5.tsv", column: 2)
#let all5 = read_data(file: "../lab2/results/2_5.tsv", column: 3)
#let matrix5 = read_data(file: "../lab2/results/2_5.tsv", column: 1)

#let core9 = read_data(file: "../lab2/results/2_9.tsv", column: 2)
#let all9 = read_data(file: "../lab2/results/2_9.tsv", column: 3)
#let matrix9 = read_data(file: "../lab2/results/2_9.tsv", column: 1)

#let data_core = (
  (1, 1), (2, core2 / core3), (4, core2 / core5), (8, core2 / core9)
)

#let data_all = (
  (1, 1), (2, all2 / all3), (4, all2 / all5), (8, all2 / all9)
)
#let data_linear = (
  (1, 1), (2, 2), (4, 4), (8, 8)
)
#let data_matrix = (
  (1, 1), (2, matrix2 / matrix3), (4, matrix2 / matrix5), (8, matrix2 / matrix9)
)
